 ...
 *
 *
 * $Log: /TaxiProduct/Code/ControlRoom/iTaxiInterface/src/com/dds/pathfinder/itaxiinterface/webservice/AdviseArrivalRequest.java $
 * 
 * 3     4/23/12 4:35p Ajiang
 * PF-14393 - added default values to optional request fields
 * 
 * 2     11/18/09 3:01p Yyin
 * Added sessionID
 * 
...
@XmlType(name = "AdviseArrivalReqType", namespace="http://com.dds.osp.itaxi.interface/", 
			propOrder = { "sessionID","taxiCoID"})
public class AdviseArrivalRequest extends BaseReq{
